from import_d import import_data
from export_d import export_data
from print_d import print_data
...
def input_data():
    ...
    about = input("Введите примечание: ")
    return [last_name, first_name, phone_number, about]
